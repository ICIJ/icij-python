...
from icij_common.test_utils import async_true_after, true_after
from icij_worker.event_publisher.amqp import Exchange, Routing
    ...
    with shutdown_nowait(ThreadPoolExecutor()) as executor:
        with consumer:
            ...
            with BlockingConnection(URLParameters(broker_url)) as connection:
                ...
                assert true_after(consumer.n_consumed, after_s=after_s), msg
